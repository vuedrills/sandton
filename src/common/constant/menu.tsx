...
export const SOCIAL_MEDIA: MenuItemProps[] = [
  ...
  {
    title: 'Email',
    href: 'mailto:reefai.eu@gmail.com',
...
export const BOOKINGLINKS: MenuItemProps[] = [
  {
    title: 'Book a lesson',
    href: 'https://cal.com/sandton/booking',
    icon: <LearnIcon size={iconSize} />,
    isShow: true,
    isExternal: true,
    eventName: 'Contact: Email',
  ...
  {
    title: 'Online Lesson',
    href: 'https://cal.com/sandton/online-lesson',
    icon: <ChatIcon size={iconSize} />,
    isShow: true,
    isExternal: true,
    eventName: 'Social: Linkedin',
