...
const SkillsA = () => {
  ...
  useEffect(() => {
    const skillsArray = Object.entries(STACKSA);
  ...
  return (
    <div className='space-y-8'>
      <div className='space-y-2'>
        ...
        />
        <SectionSubHeading>
          <p className='dark:text-neutral-400'>Zimsec and Cambridge</p>
        </SectionSubHeading>
      </div>
